...
Detail.delete_all
Detail.create!(order:@o,name: "test", qty:1)
Detail.create!(order:@o,name: "test",  qty:2)
Detail.create!(order:@o,name: "test",  qty:3)
Detail.create!(order:@o1,name: "test",  qty:4)
Detail.create!(order:@o1,name: "test",  qty:5)
Detail.create!(order:@o1,name: "test",  qty:6)
Detail.create!(order:@o2,name: "test",  qty:7)
Detail.create!(order:@o2,name: "test",  qty:8)
Detail.create!(order:@o2,name: "test",  qty:9)
Detail.create!(order:@o2,name: "test",  qty:10)
Detail.create!(order:@o3,name: "test",  qty:21)
Detail.create!(order:@o3,name: "test",  qty:12)
Detail.create!(order:@o4,name: "test",  qty:1)
Detail.create!(order:@o4,name: "test",  qty:12)
Detail.create!(order:@o5,name: "test",  qty:12)
Detail.create!(order:@o5,name: "test",  qty:12)
