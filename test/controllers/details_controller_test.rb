...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { order_id: @detail.order_id, price: @detail.price, product_id: @detail.product_id, qty: @detail.qty, remark: @detail.remark } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { order_id: @detail.order_id, price: @detail.price, product_id: @detail.product_id, qty: @detail.qty, remark: @detail.remark } }
